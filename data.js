...
var GUITAR_REF_VOICINGS = {
  // --- Triads ---
  '0:0,4,7':  ['x,3,2,0,1,0','x,3,5,5,5,3','x,3,2,0,1,3','8,10,10,9,8,8','8,7,5,5,5,8','8,7,5,5,8,x'],  // C
  '9:0,3,7':  ['x,0,2,2,1,0','5,7,7,5,5,5','5,7,7,5,5,8','5,3,2,2,5,x'],  // Am
  '7:0,4,7':  ['3,2,0,0,0,3','3,2,0,0,3,3','3,5,5,4,3,3','x,10,9,7,8,7'],  // G
  '2:0,4,7':  ['x,x,0,2,3,2','x,5,4,2,3,2','x,5,7,7,7,5','10,12,12,11,10,10'],  // D
  '4:0,4,7':  ['0,2,2,1,0,0','x,7,6,4,5,4','x,x,2,4,5,4','x,7,9,9,9,7'],  // E
  '5:0,4,7':  ['1,3,3,2,1,1','1,0,3,2,1,x','x,8,7,5,6,5','x,x,3,5,6,5','x,8,10,10,10,8'],  // F
  '1:0,3,7':  ['x,4,6,6,5,4','9,11,11,9,9,9','x,4,2,1,2,x'],  // C#m
  '11:0,3,7': ['x,2,4,4,3,2','2,2,4,4,3,2','7,9,9,7,7,7'],  // Bm
  '6:0,3,7':  ['2,4,4,2,2,2','2,0,4,2,2,2'],  // F#m
  '9:0,4,7':  ['x,0,2,2,2,0','0,0,2,2,2,0','5,4,2,2,2,x','5,7,7,6,5,5'],  // A
  // --- 7th Chords ---
  '0:0,4,7,10': ['x,3,2,3,1,0','x,3,5,3,5,3','8,10,8,9,8,8'],  // C7
  '0:0,4,7,11': ['x,3,2,0,0,0','x,3,2,0,0,3','x,3,5,4,5,3','8,10,9,9,8,8'],  // Cmaj7
  '9:0,3,7,10': ['x,0,2,0,1,0','x,0,2,0,1,3','x,0,2,2,1,3','5,7,5,5,5,5'],  // Am7
  '7:0,4,7,10': ['3,2,0,0,0,1','3,2,3,0,0,3','3,5,3,4,3,3'],  // G7
  '2:0,3,7,10': ['x,x,0,2,1,1','x,5,7,5,6,5','x,5,3,5,3,5'],  // Dm7
  '9:0,4,7,11': ['x,0,2,1,2,0','0,0,2,1,2,0'],  // Amaj7
  '11:0,3,7,10':['x,2,0,2,0,2','x,2,4,2,3,2'],  // Bm7
  '1:0,3,7,10': ['x,4,6,4,5,4','9,11,9,9,9,9'],  // C#m7
  '2:0,4,7,11': ['x,x,0,2,2,2','x,0,0,2,2,2','x,5,4,2,2,2'],  // Dmaj7
  '4:0,4,7,10': ['0,2,0,1,0,0','0,2,2,1,3,0'],  // E7
  '6:0,3,7,10': ['2,0,2,2,2,0','2,0,2,2,2,2','2,4,2,2,2,2'],  // F#m7
  // --- sus4 ---
  '0:0,5,7':  ['x,3,3,0,1,1','x,3,3,0,1,3','x,3,5,5,6,3'],  // Csus4
  '2:0,5,7':  ['x,x,0,2,3,3','x,0,0,2,3,3','x,5,7,7,8,5'],  // Dsus4
  '4:0,5,7':  ['0,0,2,2,0,0','0,2,2,2,0,0'],  // Esus4
  '9:0,5,7':  ['x,0,0,2,3,0','0,0,0,2,3,0','0,0,2,2,3,0'],  // Asus4
  '7:0,5,7':  ['3,3,0,0,3,3','3,3,0,0,1,3','3,3,5,5,3,3'],  // Gsus4
  // --- 7sus4 ---
  '0:0,5,7,10': ['x,3,3,3,1,1','x,3,3,3,1,3'],  // C7sus4
  '2:0,5,7,10': ['x,x,0,0,1,3','x,x,0,2,1,3','x,5,7,5,8,5'],  // D7sus4
  '4:0,5,7,10': ['0,0,0,2,0,0','0,2,0,2,0,0'],  // E7sus4
  '9:0,5,7,10': ['x,0,0,0,3,0','0,0,0,0,3,0'],  // A7sus4
  '7:0,5,7,10': ['3,3,3,0,3,x','3,3,0,0,1,1','3,5,3,5,3,3'],  // G7sus4
  // --- Tensions ---
  '0:0,4,7,14': ['x,3,2,0,3,0','x,3,2,0,3,3'],  // Cadd9
  '9:0,3,7,10,14': ['5,7,5,5,5,7','5,3,5,5,5,7','5,7,5,5,8,7'],  // Am9
  '0:0,4,7,11,14': ['x,3,2,4,3,x','x,3,2,4,3,3'],  // Cmaj9
  '7:0,4,7,10,21': ['3,2,3,0,0,0','3,2,2,0,0,1'],  // G13
  '2:0,3,7,10,17': ['x,5,3,5,3,3','x,5,5,5,6,5'],  // Dm11
};
